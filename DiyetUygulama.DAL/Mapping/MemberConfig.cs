...
namespace DiyetUygulama.DAL.Mapping
{
    public class MemberConfig : IEntityTypeConfiguration<Member>
    {
        public void Configure(EntityTypeBuilder<Member> builder)
        {
            ...
            builder.Property(x => x.MemberName).IsRequired().HasColumnType("nvarchar").HasMaxLength(30);
            builder.Property(x => x.MemberSurname).IsRequired().HasColumnType("nvarchar").HasMaxLength(50);
