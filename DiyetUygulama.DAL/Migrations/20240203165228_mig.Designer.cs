            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdminName = "admin",
                            AdminSurname = "admin",
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2601),
            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = 1,
                            CategoryName = "Et",
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2587),
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.Meal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MealId = 1,
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2616),
                            MealDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2616),
                            MealType = 1,
                            MemberId = 1,
                            Status = 0
                        });
            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MemberId = 1,
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2460),
                            Email = "member@member.com",
                            MemberName = "Tümay",
                            MemberSurname = "Özyazıcı",
                            MembershipDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2446),
                            Password = "password",
                            Status = 0
                        });
                });
            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.MemberDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Allergy1 = 0,
                            Allergy2 = 1,
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2572),
                            FatRatio = 20.0,
                            Gender = true,
                            Height = 180.0,
                            IsDiabetes = true,
            ...
            modelBuilder.Entity("DiyetUygulama.DATA.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 2, 3, 19, 52, 28, 515, DateTimeKind.Local).AddTicks(2625),
                            Fat = 10.56,
                            HasGluten = false,
                            HasLactose = false,
                            MealId = 1,
